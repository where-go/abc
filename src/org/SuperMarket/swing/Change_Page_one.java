...
public class Change_Page_one {

	
	void Change_Page_one() {
...
/*-----------------------------设置中间面板的内容---------------------------------------------*/		
		...
		/*------设置一个JLabel，并设置它的样式-------*/
		JLabel JL_down_name = new JLabel("请输入需更改商品的名称 ：");
		//设置JL_down_name的字体样式
		...
		btn1.addMouseListener(new MouseAdapter() {	
			public void mouseClicked(MouseEvent e) {
				...
				if(SPoD.l=="1") {                             //判断是否找到了这条数据，找到则跳转到Search_Page_second
					...
					jf.setVisible(false);
					Change_Page_second SPe = new Change_Page_second();
					SPe.Change_Page_second();
