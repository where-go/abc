...
public class Search_Page_second {
	
	public JTextField jt1 = new JTextField(8); 
	public JTextField jt2 = new JTextField(8); 
	public JTextField jt3 = new JTextField(8); 
	public JTextField jt4 = new JTextField(8); 
	public JTextField jt5 = new JTextField(8); 
	public JTextField jt6 = new JTextField(8); 
	public JTextField jt7 = new JTextField(11); 
	public JTextField jt8 = new JTextField(11); 
	public JTextField jt9 = new JTextField(11); 
	
	void Search_Page_second(){
...
//		JTextField jt1 = new JTextField(8);            
		jt1.setFont(new Font(null, Font.PLAIN, 18));
...
//		JTextField jt2 = new JTextField(8);             
		jt2.setFont(new Font(null, Font.PLAIN, 18));
...
//		JTextField jt3 = new JTextField(8);                
		jt3.setFont(new Font(null, Font.PLAIN, 18));
//		JTextField jt4 = new JTextField(8);                
		jt4.setFont(new Font(null, Font.PLAIN, 18));
...
//		JTextField jt5 = new JTextField(8);                
		jt5.setFont(new Font(null, Font.PLAIN, 18));
//		JTextField jt6 = new JTextField(8);                
		jt6.setFont(new Font(null, Font.PLAIN, 18));
...
//		JTextField jt7 = new JTextField(8);               
		jt7.setFont(new Font(null, Font.PLAIN, 18));
...
//		JTextField jt8 = new JTextField(8);               
		jt8.setFont(new Font(null, Font.PLAIN, 18));
...
//		JTextField jt9 = new JTextField(8);                        
		jt9.setFont(new Font(null, Font.PLAIN, 18));
...
/*---------------------------设置按钮监听事件----------------------------------------------------*/
		...
		btn2.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				jf.setVisible(false);
				Search_Page_one SPO = new Search_Page_one();
				SPO.Search_Page_one();                  //跳到Search_Page_one
			}
		});
