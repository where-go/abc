...
public class Change_Page_second {
	...
	JTextField jt9 = new JTextField(11);


	void Change_Page_second(){
...
/*------------------------------设置按钮监听事件-----------------------------------------*/
		...
		btn1.addMouseListener(new MouseAdapter() {	
			public void mouseClicked(MouseEvent e) {
				Change_Page_second_Dao CPSD = new Change_Page_second_Dao();
				CPSD.Change_Page_second_Dao( jt1.getText().toString(), 
		...
		btn2.addMouseListener(new MouseAdapter() {	
			public void mouseClicked(MouseEvent e) {
				jf.setVisible(false);
				Change_Page_one SP = new Change_Page_one();
				SP.Change_Page_one();                    //跳到Search_Page_one
			}
		});
/*------------------------------------------------------------------------------------*/
