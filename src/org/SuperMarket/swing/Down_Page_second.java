...
//		JTextField jt9 = new JTextField(8);                        
		...
		//设置一个“提交”和“返回”的button
		JButton btn1 = new JButton("下架");
...
/*-----------------------------设置按钮监听事件---------------------------------------------*/
		...
		btn1.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				Down_Page_second_Dao DPED = new Down_Page_second_Dao();
				DPED.Down_Page_second_Dao(jt2.getText().toString());
		...
		btn2.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				jf.setVisible(false);
				Down_Page_one CP = new Down_Page_one();
				CP.Down_Page_one();                   //跳到Change_Page_one
			}
		});
